...
export default function ControlledOpenSelect({setQuality}) {
  ...
  useEffect(() =>{
    setContent(
      [
        { id: 'BAD', name: 'Bad quality'},
        { id: 'SATISFACTORY', name: 'Satisfactory quality'},
        { id: 'GOOD', name: 'Good quality'},
        { id: 'VERY_GOOD', name: 'Very good quality'},
      ]
    )
